...
TONES = {
    "professionnel": (
        "Écris de manière professionnelle et sobre. "
        "Phrases courtes, vocabulaire précis, pas d'émojis. Adapté à un cadre ou recruteur."
    ),
    "storytelling": (
        "Écris comme une histoire personnelle et engageante. "
        "Commence par une accroche forte, crée de l'émotion, conclus avec une leçon ou un appel à l'action."
    ),
    "technique": (
        "Écris pour un public technique. "
        "Mets en avant les détails concrets : stack, architecture, décisions techniques. Pas de flou."
    ),
}
